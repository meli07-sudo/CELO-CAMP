<div class="course-item card course">
    ...
    <div class="card-body">
        <h5 class="card-title poppins-semibold text-capitalize">Finance décentralisée</h5>
        <div class="course-categories">
            <span class="course-category d-inline-block poppins-extralight small">Catégorie
                1</span>&nbsp;&dash;&nbsp;<span class="course-category d-inline-block poppins-extralight small">Catégorie
